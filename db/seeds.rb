...
# Contact.create(name: 'Ngoc Quy Hoang', email: 'ngocquyhoang.93@gmail.com' ) 
# Message.create(name: 'Hoang Ngoc Quy', mail: 'ngocquyhoang.93@gmail.com', message: 'This OK')
ViewPage.create(home_page: 0, zorba_page: 0, contact_page: 0, contributed_image_page: 0)
