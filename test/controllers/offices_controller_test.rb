...
class OfficesControllerTest < ActionController::TestCase
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post :create, office: { dislike: @office.dislike, image: @office.image, like: @office.like, owner: @office.owner, title: @office.title }
    end
  ...
  test "should update office" do
    patch :update, id: @office, office: { dislike: @office.dislike, image: @office.image, like: @office.like, owner: @office.owner, title: @office.title }
    assert_redirected_to office_path(assigns(:office))
  end
